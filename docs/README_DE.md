...
| **🛠️ Lint Wiki** | `Cmd+P` → "Lint Wiki" — Health Scan mit Duplikat-Detection, tote Links, Orphans |
...
| **🛠️ Lint wiki** | Vollständiger Health Scan: Duplikate, tote Links, leere Pages, Orphans, fehlende Aliases, Widersprüche |
