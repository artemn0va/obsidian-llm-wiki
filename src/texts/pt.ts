export const PT_TEXTS = {
    ...
    maxTokensPerCallName: 'Máx. de tokens por chamada',
    maxTokensPerCallDesc: 'Limitar saída LLM para modelos locais. 0 = sem limite (padrão cloud). 4K/8K recomendado para LM Studio/Ollama.',
